...
export interface DialogMemberConfirmDeleteConfig {
  onDelete: () => void;
  open: boolean;
...
export const DialogMemberConfirmDelete = (config: DialogMemberConfirmDeleteConfig) => {
    ...
    <Dialog open={config.open} onOpenChange={(open) => config.setOpen(open)}>
      <DialogContent className="sm:max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>
            Se realizará la eliminación del miembro de <strong>forma definitiva</strong>, ¿deséa continuar?
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
