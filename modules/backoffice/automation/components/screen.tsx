...
export const AutomationBackofficeScreen = () => {
  ...
  const OnCreateItem = async (data: CreationSchema) => {
    try {
      ...
      const req = await createItem.mutateAsync({
        ...
        userCreationId: data.userCreationId
      })
  ...
  return (<>
    <div className="relative h-full px-12 flex flex-col">
      ...
      {/* start::header */}
      <SectionHeader
        title={'Administracion de automatizaciones'}
        description={'Pantalla de administración de automatizaciones'}
