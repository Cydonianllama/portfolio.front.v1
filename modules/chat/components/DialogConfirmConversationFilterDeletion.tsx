...
export interface DialogConfirmDeleteConversationFilterConfig {
  onDelete: () => void
  open: boolean
...
export const DialogConfirmDeleteConversationFilter = (config: DialogConfirmDeleteConversationFilterConfig) => {
