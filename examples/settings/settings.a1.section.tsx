    ...
    <div className="w-full px-20 flex flex-col py-4 gap-5">
      ...
      <div>
        <div className="flex items-center justify-between">
          <div className="font-semibold">Configuraciones iniciales</div>
          <Button variant="link" className="group/link-button">
            View Documentation
            <LuCopy aria-hidden="true" className="transition-transform ------group-hover/link-button:rotate-45" />
          </Button>
        </div>
        <div className="flex gap-2 items-center py-3">
          <Pattern maxSize={100000} onFileChange={() => { }} />
          <div>
            <div className="font-semibold">Configuraciones iniciales</div>
            <div className="">Lorem ipsum, dolor sit amet consectetur adipisicing.</div>
          </div>
        </div>
        <div>
          <FieldGroup>
            <Field orientation="horizontal">
              <FieldContent>
                ...
                <FieldDescription>
                  Como tu workspace debe ser reconocido.
                </FieldDescription>
      ...
      <div className="flex flex-col gap-7.5">
        <div className="font-semibold">Configuraciones iniciales</div>
        <ItemGroup>
          <Item className="p-0" variant="default" size="sm">
