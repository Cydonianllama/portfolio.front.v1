...
type NameComponentListProps = {
  list: Array<name_entityDTO>,
  isLoading: boolean
  isError: boolean
  HandleDragEndEvent?: (event: DragEndEvent) => void;
  onClickEdit?: (id: string, item: name_entityDTO) => void
  onClickDelete?: (id: string, item: name_entityDTO) => void
}

export const NameComponentList_ = ({ isLoading, isError, list, HandleDragEndEvent, onClickDelete, onClickEdit }: NameComponentListProps) => {
...
export const SortableItem = ({ id, data, onClickDelete, onClickEdit }: SortableItemProps) => {
  ...
  const HandleClickEdit = (id: string, item: name_entityDTO) => {
    if (onClickEdit) onClickEdit(id, item)
  }

  const HandleClickDelete = (id: string, item: name_entityDTO) => {
